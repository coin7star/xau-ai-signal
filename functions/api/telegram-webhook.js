...
export async function onRequest({ request, env }) {
  ...
  if (request.method !== "POST") {
    return json({ ok: true, message: "Telegram webhook ready. Use POST only." });
  }
  ...
  if (command === "/start") {
    ...
    // HARD DISABLE:
    // Command lama tidak boleh lagi baca Firebase / RTDB.
    // Cuma redirect ke Mini App biar hemat bandwidth.

...
function buildSignal(candles, market) {
  /*
    FIX RSI:
    - Versi lama pakai RSI simple average, makanya beda jauh dari MT5.
    - Versi ini pakai RSI Wilder/SMMA style seperti iRSI MetaTrader.
    - Pakai candle terakhir dari data MT5.
  */
  ...
  if (!last || closes.length < 35) {
    return {
      ...
      strategy: {
        rsi: null,
        rsiMethod: "Wilder RSI 14 like MT5 iRSI",
        ema9: null,
        ema20: null,
        emaCross: "WAIT",
        orderBlock: null,
...
function rsiWilder(values, period = 14) {
  /*
    MetaTrader iRSI memakai Wilder smoothing:
